...
export async function updateWorkType(
  ...
  const response = await api.put<{
    success: boolean;
    data: { type: WorkType };
  }>(`/registration-work/types/${id}`, data);
  return response.data.data.type;
}
...
export async function reorderWorkTypes(
  ...
  await api.post("/registration-work/types/reorder", { items });
}
...
export async function createSubType(data: {
  ...
  const response = await api.post<{
    success: boolean;
    data: { sub_type: WorkSubType };
  }>("/registration-work/sub-types", data);
...
export async function updateSubType(
  ...
  const response = await api.put<{
    success: boolean;
    data: { sub_type: WorkSubType };
  }>(`/registration-work/sub-types/${id}`, data);
  return response.data.data.sub_type;
}
...
export async function reorderSubTypes(
  ...
  await api.post("/registration-work/sub-types/reorder", { items });
}
...
export async function createTeamStatus(data: {
  ...
  }>("/registration-work/team-statuses", data);
...
export async function updateTeamStatus(
  ...
  const response = await api.put<{
    success: boolean;
    data: { status: TeamStatus };
  }>(`/registration-work/team-statuses/${id}`, data);
  return response.data.data.status;
}
