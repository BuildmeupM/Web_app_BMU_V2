...
const statusOptions = [
  { value: 'received_receipt', label: 'รับใบเสร็จ' },
...
// Quick Filter Options (สถานะที่ใช้บ่อยสำหรับยื่นภาษี)
const quickFilters = [
  { label: 'รอส่ง', wht: ['not_started', 'draft_ready'], vat: ['not_started', 'draft_ready'] },
  { label: 'ส่งแล้ว', wht: ['sent_to_customer', 'paid', 'received_receipt'], vat: ['sent_to_customer', 'paid', 'received_receipt'] },
]
