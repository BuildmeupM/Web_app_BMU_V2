-- Migration: 022_add_tax_review_notification_types.sql
-- Description: เพิ่ม notification types สำหรับการแจ้งเตือนเมื่อส่งรอตรวจ
-- Created: 2026-01-31

-- เพิ่ม notification types ใหม่สำหรับ Tax Review
